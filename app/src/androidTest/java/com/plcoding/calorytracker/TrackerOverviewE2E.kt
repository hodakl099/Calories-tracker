...
import com.plcoding.tracker_presentation.tracker_overview.TrackerOverViewModel
...
class TrackerOverviewE2E {
    ...
    private lateinit var trackerOverviewViewModel: TrackerOverViewModel
    ...
    fun setUp() {
        ...
        trackerUseCases = TrackerUseCases(
            trackFood = TrackedFood(repositoryFake),
        ...
        trackerOverviewViewModel = TrackerOverViewModel(
            ...
            CaloryTrackerTheme {
                ...
                Scaffold(
                    ...
                    NavHost(
                        ...
                        startDestination = Route.TRACKER_OVERVIEW_ROUTE
                    ) {
    ...
    fun addBreakfast_appearsUnderBreakfast_nutrientsProperlyCalculated() {
        ...
        assertThat(
            navController
                .currentDestination
                ?.route
                ?.startsWith(Route.TRACKER_OVERVIEW_ROUTE)
        )
